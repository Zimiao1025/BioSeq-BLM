...
python BioSeq-BLM_Res.py -category DNA -method NCP -ml ${ml} -seq_file ${seq_file} -label_file ${label_file} -cpu ${cpu} -bp 1
python BioSeq-BLM_Res.py -category DNA -method RSS -ml ${ml} -seq_file ${seq_file} -label_file ${label_file} -cpu ${cpu} -bp 1

python extract_data.py Res/RNA
python extract.py Res/RNA