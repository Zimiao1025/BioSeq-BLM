...
def dict2csv(data_dict, out_path):
    ...
    header = ['BLMs', 'Acc', 'MCC', 'AUC', 'BAcc', 'Sn', 'Sp', 'Precision', 'Recall', 'F1']
    ...
    for root, dirs, files in os.walk(source_path):
        ...
        for f in files:
            ...
            if f == "final_results.txt":
                ...
                # ../results/batch/Res/Protein/
                tag = str(re_path.split('/')[-2])
...
def main():
    t = sys.argv[1]
    source_path = '../results/batch/Res/' + str(t) + '/'
    target_path = '../results/extract_data_res/' + str(t) + '/'
